      ...
      {totalPages > 0 && (
        <div className="flex items-center gap-1">
          <Button
            ...
            className="px-3 py-1 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-black
            ...
            {pageNumbers.map((page, index) =>
              typeof page === 'number' ? (
                <Button
                  ...
                  className={twMerge(
                    'min-w-[2.2rem] h-8 px-2 text-sm font-medium rounded-lg',
                    'transition-all duration-200 transform hover:scale-105',
                    'border shadow-sm hover:shadow-md',
                    page === currentPage
                      ? 'bg-gradient-to-br from-orange-400 to-orange-500 text-white border-orange-500 shadow-md'
                      : 'text-gray-700 dark:text-gray-300 bg-white dark:bg-black border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750'
                  )}
                >
                  {page}
                </Button>
                ...
                <span
                  key={`ellipsis-${index}`}
                  className="px-2 py-1 text-gray-400 dark:text-gray-500 select-none flex items-center"
                >
