  ...
  return (
    <Dropdown align="right" className="relative">
      ...
      <DropdownContent className="w-fit sm:w-72 rounded-lg shadow-lg bg-white dark:bg-[#1C1C1D]    fixed sm:absolute left-2 sm:left-auto right-2 sm:right-0 mt-2">
        ...
        >
          <div
            className="absolute right-0 z-20 w-80 mt-2 bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-black dark:divide-gray-700"
            aria-labelledby="dropdownNotificationButton"
          >
            <div className="block px-4 py-2 font-medium text-center text-gray-700 rounded-t-lg bg-gray-50 dark:bg-black dark:text-white">
              Notifications
            </div>
            ...
            <div className="divide-y divide-gray-100 dark:divide-gray-700 max-h-96 overflow-y-auto">
              ...
              <a
                href="#"
                className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700 relative"
              >
                ...
                <div className="w-full ps-3">
                  ...
                  <div className="text-xs text-orange-600 dark:text-primary">
                    2 minutes ago
                  </div>
                </div>
              </a>
            ...
            <a
              href="#"
              className="block py-2 text-sm font-medium text-center text-gray-900 rounded-b-lg bg-gray-50 hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-700 dark:text-white"
            >
