        ...
        <footer className="bg-black/90 border-t border-cyan-400/50 py-12 px-4 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        <div className="flex items-center mb-4">
                            ...
                            <Text as="h3" size="lg" className="font-bold text-xl text-cyan-300 font-orbitron"
                                style={{
                        ...
                        <Text className="max-w-xs text-purple-200 leading-relaxed font-orbitron" style={{ textShadow: '0 0 5px rgba(147, 51, 234, 0.4)' }}>
                    ...
                    {/* Links */}
                    <div>
                        <Text as="h4" className="font-semibold mb-4 text-cyan-300 font-orbitron" size="lg">
                            Navigation Matrix
                        </Text>
                        <div className="space-y-3">
                            {['Interdimensional Features', 'Gateway Pricing', 'Quantum Support', 'Cosmic About'].map((link) => (
                                <div key={link}>
                                    <Text variant="muted" className="text-purple-200 hover:text-cyan-300 cursor-pointer transition-all duration-300 hover:translate-x-1 font-orbitron" style={{ textShadow: '0 0 5px rgba(147, 51, 234, 0.3)' }}>
                                        {link}
                                    </Text>
                                </div>
                            ))}
                ...
                <div className="border-t border-cyan-400/20 pt-6 flex flex-col md:flex-row justify-between items-center">
                    <Text variant="muted" size="sm" className="text-purple-200/80 font-orbitron">
                        © 2025 Stargate. All interdimensional rights reserved.
                    </Text>
                    <div className="flex space-x-6 mt-4 md:mt-0">
                        <Text variant="muted" size="sm" className="text-cyan-300 hover:text-cyan-200 hover:translate-y-px cursor-pointer transition-all duration-300 font-orbitron" style={{ textShadow: '0 0 3px rgba(34, 211, 238, 0.3)' }}>
                            Privacy Matrix
                        </Text>
                        <Text variant="muted" size="sm" className="text-cyan-300 hover:text-cyan-200 hover:translate-y-px cursor-pointer transition-all duration-300 font-orbitron" style={{ textShadow: '0 0 3px rgba(34, 211, 238, 0.3)' }}>
                            Quantum Terms
