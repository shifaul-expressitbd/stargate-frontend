...
import { FaChevronLeft, FaChevronRight, FaExternalLinkAlt, FaPlus, FaRocket, FaShieldAlt } from 'react-icons/fa';
                    ...
                    <div className="space-y-6 xl:col-span-2">
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <button className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 text-white text-sm font-orbitron rounded-md shadow-lg hover:opacity-90 transition-opacity flex items-center gap-2">
